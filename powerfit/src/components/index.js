...
export { default as DropDownGenerico } from "./DropDownGenerico/DropDownGenerico";
export { default as Footer } from "./Footer/Footer";
export { default as Header } from "./Header/Header";
export { default as HeaderLogado } from "./HeaderLogado/HeaderLogado";

export { default as InputGenerico } from "./InputGenerico/InputGenerico";
